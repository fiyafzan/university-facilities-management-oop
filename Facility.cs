...
namespace ioopassignment
{
    internal class Facility
    {
        ...
        public Facility(string university, string facilitycategory, string facilityrate, string capacity)
        {
        ...
        public string addFacility()
        {
            ...
            SqlCommand cmd = new SqlCommand("Insert into facilities(university, [facility category], [facility rate (/hr)], capacity) values(@university,@facilitycategory,@facilityrate,@capacity)", con);
