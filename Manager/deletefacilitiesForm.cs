    ...
    public partial class deletefacilitiesForm : Form
    {
        ...
        private void btnConfirmDeleteFacilities_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int selectedId = Convert.ToInt16(dataFacilityDetails2.SelectedRows[0].Cells["Id"].Value);
                ...
                {
                    conn.Open();
                    string deleteQuery = "DELETE FROM facilities WHERE Id = @id"; // Delete specific row
